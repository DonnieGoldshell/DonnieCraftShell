...
- Economy architecture now includes explicit `EconomyAsset`, `EconomySnapshot`, `ExchangeRate`, freshness, and normalized `EconomyQuote` concepts for Task 6B. See [ECONOMY.md](ECONOMY.md) and [ECONOMY_IMPORT.md](ECONOMY_IMPORT.md).
